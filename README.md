...
Features are listed in order of how they appear on the backlog with Release 1 first then Release 2 at the following site:

http://jnoll.nfshost.com/cs4098/projects/d-cyborgs-backlog.html

##Release 1

###Master Config - Feature 17
####Description
Contains global values and constants, see the bottom of this README for more details.
####How to Evaluate
Changing values in the config will alter how the simulation runs. For example, changing the problem constant to 0.1 will result in problems occurring extremely frequently. Alternatively deleting or adding items in the interventions array will alter which interventions, if any the player sees when they open the interventions menu.
